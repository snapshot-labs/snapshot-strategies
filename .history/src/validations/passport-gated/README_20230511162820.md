...
This implementation uses the Gitcoin Passport API to checks whether a user has a valid passport by utilizing the Gitcoin API. Instead of using the Passport SDK, we can now check for a user's valid passport by looking for a score.
