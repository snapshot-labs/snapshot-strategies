...
Osend the signed message along with other arguments in a separate API call to submit their passport

*/

    /* todo submit user's passport for scoring */

    /* todo check the user's passport score */
