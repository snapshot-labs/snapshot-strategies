...
export default class extends Validation {
    ...
    /* check the user's passport for scoring */
    async checkPassport(currentAddress = this.author) {
        //setScore('')
        //setNoScoreMessage('')
    ...
    async validate(currentAddress = this.author): Promise<boolean> {
        const GET_PASSPORT_SCORE_URI = `https://api.scorer.gitcoin.co/registry/score/${SCORER_ID}/${currentAddress}`let score = '';
        const scoreMessage = '';
