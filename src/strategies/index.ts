...
import * as orangeReputationCampaignIdWeighted from './orange-reputation-campaign-id-weighted';
...
const strategies = {
  ...
  'orange-reputation-campaign-id-weighted': orangeReputationCampaignIdWeighted
};
