    ...
    Object.entries(score).map((address: any, index) => {
      ...
      */
      return [
        ...
        increase_in_voting * 
        (parseFloat(formatUnits(usersNewAquaPoolBalances[index]['2'].toString(), 18))) +

        (parseFloat(
          formatUnits(usersNewAquaBtcbVaultBalances[index]['2'].toString(), 18)
        ) == 0 ? 0 :
        (parseFloat(
          formatUnits(usersNewAquaBtcbVaultBalances[index]['2'].toString(), 18)
        ) /
          ...
          (parseFloat(formatUnits(usersEarningSharesInAquaBtcbPool[index].toString(),18)) / 
          parseFloat(
            formatUnits(usersNewAquaBtcbVaultBalances[index]['2'].toString(), 18)
          )))
      ];
