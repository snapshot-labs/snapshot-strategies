...
const SHINOBI_SUBGRAPH_URL = {
  '8': 'https://graphnode.octano.dev/subgraphs/name/octanolabs/shinobi'
};

export const author = 'scrappydew';
...
export async function strategy(
  ...
  const result = await subgraphRequest(SHINOBI_SUBGRAPH_URL[network], params);
  const score = {};
